...
`tiposTriagem` em `message.repository.js`:
...
`tiposTriagem` só acrescenta o terceiro caso.) Teste em
`message.repository.test.js`: com `tiposTriagem: true`, uma imagem enviada
