...
export function IconBellOff(props) {
  return (
    <Svg {...props}>
      <path
        d="M12 22a2.2 2.2 0 002.2-2.1H9.8A2.2 2.2 0 0012 22zm6.5-5.4v-5a6.6 6.6 0 00-5-6.4V4.4a1.5 1.5 0 00-3 0v.8a6.6 6.6 0 00-5 6.4v5L4 18.2v.9h16v-.9z"
        opacity=".5"
      />
      <path d="M4.1 2.8L2.8 4.1l17.1 17.1 1.3-1.3z" />
    </Svg>
  );
}
...
export function IconServer(props) {
  return (
    <Svg {...props}>
      <path d="M4 3h16a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1zm1 2v3h14V5zm-1 8h16a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1v-5a1 1 0 011-1zm1 2v3h14v-3zm1-9.5h2v2H6zm0 10h2v2H6z" />
    </Svg>
  );
}
...
export function IconBrain(props) {
  return (
    <Svg {...props}>
      <path d="M9 2a3.5 3.5 0 00-3.4 2.7A3.5 3.5 0 003 8.3 3.5 3.5 0 004 14a3.5 3.5 0 002.6 5.2A3 3 0 0011 20v-3.2a5 5 0 01-2.4-1.3l1.4-1.4A3 3 0 0011 14.6V11H9V9h2V6.5A2.5 2.5 0 009 4a1.5 1.5 0 00-1.4 1H5.7A3.5 3.5 0 019 2zm6 0a3.5 3.5 0 013.3 3H16.4A1.5 1.5 0 0015 4a2.5 2.5 0 00-2 2.5V9h2v2h-2v3.6a3 3 0 001 .5l1.4 1.4a5 5 0 01-2.4 1.3V20a3 3 0 004.4-.8A3.5 3.5 0 0020 14a3.5 3.5 0 001-5.7 3.5 3.5 0 00-2.6-3.6A3.5 3.5 0 0015 2z" />
    </Svg>
  );
}
