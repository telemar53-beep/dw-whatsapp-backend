...
describe('CampaignDetailPage', () => {
  test('shows the counters and the recipient list', async () => {
    api.getCampaign.mockResolvedValue({
      id: 'campaign-1', name: 'Aviso', channelName: 'Berg', totalRecipients: 2, sentCount: 1, failedCount: 1, skippedCount: 0,
      recipients: [
  ...
  test('shows the campaign channel', async () => {
    api.getCampaign.mockResolvedValue({
      id: 'campaign-1', name: 'Aviso', channelName: 'Berg', totalRecipients: 0, sentCount: 0, failedCount: 0, skippedCount: 0, recipients: [],
    });
    renderPage();
  ...
  test('arms a 5-second poll while the campaign is still processing', async () => {
    api.getCampaign.mockResolvedValue({
      id: 'campaign-1', name: 'Aviso', channelName: 'Berg', totalRecipients: 2, sentCount: 0, failedCount: 0, skippedCount: 0, recipients: [],
    });
